...
$env:BT_EXTRA_INPUTS = '[{"id":"in_3","value":20000},{"id":"in_4","value":1.0},{"id":"in_5","value":1.5},{"id":"in_6","value":15},{"id":"in_7","value":true},{"id":"in_8","value":20260822},{"id":"in_9","value":20260922},{"id":"in_10","value":20},{"id":"in_11","value":false}]'
$map = @{
...
$env:BT_TFS = '30'
$env:BT_SYMBOLS = 'NSE:SBIN260929C990,NSE:SBIN260929P990'
$env:BT_OUT = "$base/bt1m_opt_30b.json"
Write-Output "===== GROUP opt1m 30b ====="
node "$base/bt_sweep2.mjs" 2>&1
$env:BT_TFS = '60'
$env:BT_SYMBOLS = ($map.Keys | Sort-Object) -join ','
$env:BT_OUT = "$base/bt1m_opt_60.json"
Write-Output "===== GROUP opt1m 60 ====="
node "$base/bt_sweep2.mjs" 2>&1
