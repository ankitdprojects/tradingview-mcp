...
$env:BT_VER = '7.0'
$env:BT_RESTORE = '{"pineId":"USER;f686f1a3397144a4bc31ea731b015e2b","pineVersion":"6.0","title":"SMA Signals","inputs":[]}'
...
function Run($group, $symbols, $tfs, $extra) {
  $env:BT_SYMBOLS = $symbols; $env:BT_TFS = $tfs; $env:BT_EXTRA_INPUTS = $extra; $env:BT_OUT = "$base/bt_sma30R_$group.json"
