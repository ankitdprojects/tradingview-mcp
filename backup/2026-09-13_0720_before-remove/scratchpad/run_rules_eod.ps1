# User rule set on options WITH session square-off. A = fake-only stop, B = + price stop.
...
$env:BT_EXTRA_INPUTS = '[{"id":"in_3","value":1},{"id":"in_24","value":5},{"id":"in_14","value":true},{"id":"in_15","value":false},{"id":"in_18","value":true},{"id":"in_21","value":false},{"id":"in_0","value":"Both"},{"id":"in_25","value":false},{"id":"in_27","value":true},{"id":"in_28","value":true},{"id":"in_31","value":true},{"id":"in_32","value":0}]'
$env:BT_CONFIGS = '[{"label":"Rules","inputs":[{"id":"in_26","value":false}]},{"label":"Rules+stop","inputs":[{"id":"in_26","value":true}]}]'
$env:BT_OUT = "$base/bt_ruleseod_${Group}.json"
