# Stand-alone FUTURES backtest: long on BUY, short on SELL, 1 lot per trade, ATR stop, 1.5R, 15 trades/day, square-off.
...
$env:BT_EXTRA_INPUTS = '[{"id":"in_12","value":1},{"id":"in_3","value":20000},{"id":"in_4","value":1.0},{"id":"in_5","value":1.5},{"id":"in_6","value":15},{"id":"in_7","value":true},{"id":"in_8","value":20260815},{"id":"in_9","value":20260922},{"id":"in_10","value":20},{"id":"in_11","value":false}]'
$map = @{
  'NSE:NIFTY1!' = @('NSE:NIFTY1!','FUT'); 'NSE:BANKNIFTY1!' = @('NSE:BANKNIFTY1!','FUT'); 'NSE:FINNIFTY1!' = @('NSE:FINNIFTY1!','FUT')
  'NSE:MIDCPNIFTY1!' = @('NSE:MIDCPNIFTY1!','FUT'); 'NSE:RELIANCE1!' = @('NSE:RELIANCE1!','FUT'); 'NSE:SBIN1!' = @('NSE:SBIN1!','FUT')
}
...
foreach ($tf in @('1','5','15','30','60')) {
  $env:BT_TFS = $tf
  $env:BT_OUT = "$base/bt_fut_$tf.json"
  Write-Output "===== GROUP fut $tf ====="
